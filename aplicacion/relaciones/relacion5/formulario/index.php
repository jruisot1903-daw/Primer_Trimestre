...
//Controlador
//inicializamos los array tanto de los valores de los datos como el que vamos a almacenar los errores
$errores = [];
$valores = [
    'nombre' => '',
    'password' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Vamos a utilizar la libreria de validaciones para validar los datos 
    ...
    if (!validaCadena($valores['password'], 15, '')) {
        ...
        $errores['password'] = 'Debe tener 8 caracteres, mayúscula, minúscula, número y carácter especial.';
    }
    ...
    if (!checkdate($valores['mes_carnet'], $valores['dia_carnet'], $valores['ano_carnet'])) {
        ...
        if ($fecha_carnet < $mayor_edad) {
            $errores['fecha_carnet'] = 'Debe ser mayor de edad para tener carnet.';
        }
    }
    ...
    if (!validaRango((int)$valores['estado'], $estados_validos, 1)) {
...
cuerpo($valores,$errores); //llamo a la vista
finCuerpo();
...
{
    // Si hay errores o primera carga → mostrar formulario
    ...
    <div class="formulario">
        ...
        echo "<li><b>Estado:</b> {$valores['estado']}</li>";
        echo "<li><b>Estudios:</b> ".implode(", ", $valores['estudios'])."</li>";
